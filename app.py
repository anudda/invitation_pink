...
<style>
    ...
    .cnt {{ color: #FF8FAB; font-size: 13px; font-weight: bold; margin: 0; font-family: 'Gaegu', cursive; }}
</style>
...
<div style="position: relative; z-index: 10;">
    <div style="background: rgba(255,255,255,0.85); padding: 25px; border-radius: 30px; text-align: center; border: 1px solid rgba(255,143,171,0.2); box-shadow: 0 8px 15px rgba(255,143,171,0.05); margin-bottom: 15px;">
        <p style="color: #FF8FAB; font-size: 0.7rem; font-weight: bold; letter-spacing: 2px; margin: 0 0 5px; font-family: 'Gowun Batang';">DATE</p>
        <p style="font-size: 1.15rem; color: #4A4A4A; margin: 0 0 15px;">2026년 10월 24일 (토) 오후 1시</p>
        <p style="color: #FF8FAB; font-size: 0.7rem; font-weight: bold; letter-spacing: 2px; margin: 0 0 5px; font-family: 'Gowun Batang';">LOCATION</p>
